        ...
        <div class="bg-white p-8 rounded-lg max-w-md w-full">
            ...
            <form id="lead-capture-form" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="message" name="message" class="w-full p-2 border rounded h-32"></textarea>
                </div>
                <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition duration-300">Enviar</button>
            </form>
            <button id="close-lead-form" class="mt-4 text-gray-600 hover:text-gray-800">Cerrar</button>
        </div>
    `;
