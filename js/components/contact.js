export function renderContact(container) {
    container.innerHTML = `
        <div class="contact-container">
            <h1 class="text-3xl font-bold mb-6 text-center">Contacta con Nosotros</h1>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="contact-info bg-white p-6 rounded-lg shadow-md">
                    <h2 class="text-2xl font-bold mb-4">Información de Contacto</h2>
                    <p class="mb-2"><i class="fas fa-map-marker-alt mr-2 text-blue-600"></i> Av. Principal 123, Ciudad</p>
                    <p class="mb-2"><i class="fas fa-phone mr-2 text-blue-600"></i> (123) 456-7890</p>
                    <p class="mb-4"><i class="fas fa-envelope mr-2 text-blue-600"></i> info@jannethaguirre.com</p>
                    <div class="map-container mt-6">
                        ...
                        <div id="map" class="h-64 bg-gray-300 rounded-lg">
                            ...
                            <img src="/placeholder.svg?height=300&width=400" alt="Mapa de ubicación" class="w-full h-full object-cover rounded-lg">
                        </div>
                    </div>
                </div>
                <div class="contact-form bg-white p-6 rounded-lg shadow-md">
                    ...
                    <form id="contact-form" class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" required class="w-full p-2 border rounded focus:border-blue-500 focus:outline-none transition duration-300 h-32"></textarea>
                        </div>
